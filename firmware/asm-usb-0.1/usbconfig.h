...
/* ---------------------------- Hardware Config ---------------------------- */
	...
	//#error NEED ADDING SUPPORT THIS!!!
...
#else
	#warning Building for VERSION 0.3
	#define USB_CFG_IOPORTNAME      D
	#define USB_CFG_DMINUS_BIT      7
	#define USB_CFG_DPLUS_BIT       2
 ...
 */
#define USB_CFG_VENDOR_NAME     'a', 's', 'm', '.', 'p', 'p', '.', 'r', 'u'
 ...
 * details.
 */
//"asm.pp.ru" (Kotel Reset)      //MicroLabSwitch
#define USB_CFG_DEVICE_NAME     'M', 'i', 'c', 'r', 'o', 'L', 'a', 'b', 'S', 'w', 'i', 't', 'c', 'h'
//#define USB_CFG_DEVICE_NAME     'K', 'o', 'm', 'd', 'i', 'v', ' ', 'R', 'e', 's', 'e', 't'
#define USB_CFG_DEVICE_NAME_LEN 14
/* Same as above for the device name. If you don't want a device name, undefine
 * the macros. See the file USBID-License.txt before you assign a name.
 */
#define USB_CFG_SERIAL_NUMBER   'm', '0', '0', '2'
